...
class MaterialTheme {
  ...
  MaterialTheme({this.displayFont = 'Rubik', this.bodyFont = 'Bree Serif'});
...
const ColorScheme lightMediumContrastScheme = ColorScheme(
  brightness: Brightness.light,
...
const ColorScheme lightHighContrastScheme = ColorScheme(
  brightness: Brightness.light,
...
const ColorScheme darkMediumContrastScheme = ColorScheme(
  brightness: Brightness.dark,
...
const ColorScheme darkHighContrastScheme = ColorScheme(
  brightness: Brightness.dark,
